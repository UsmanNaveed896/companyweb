    ...
    return (
        <>
            ...
            <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                ...
                <link href="https://fonts.googleapis.com/css?family=Raleway,family=FontAwesome:500,600,700&display=swap"
                    rel="stylesheet" />
                {/* //,,,,,,SCRIPTS  FOR AOS .......... */}
            ...
            <nav>
                <div className="flex header-desktop-view">
                    <div className="logo-image-designers w-2/5 mt-10 ml-16">
                        <div className="logo flex justify-center"> <Link to="/"><img className="mob-header" src={Logo} alt="logo" /></Link></div>
                    </div>
                    <div className="list-nav-items w-2/3 flex justify-end mr-auto ">
                        ...
                        <div className="the-designers-nav-img absolute">
                            <ul className="listing-nav flex pt-8 pr-20 f-s-22 f-fm mt-16 f-clr-black">
                                <li className=" f-clr-black"><Link to="/who-we-are/">Who We Are</Link></li>
                ...
                <div className="Ham"><img className="ham-burger" src={Hamburgersvg} onClick={() => openNav()} /></div>
            </nav>
        </>
    )
}