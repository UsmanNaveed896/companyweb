                        ...
                        <div className="container-fluid Last-section-Agency-Task ">
                            <div className="Last-section w-full flex justify-center">
                                ...
                                <div className="Agency-tasks w-11/12 absolute  ">
                                    <div className="leaf-design-img ml-40">
                                        <img className="leaf h-20" src={Leafimg} alt="leaf-img" />
                                    </div>
                                    <div className="main-head-last-sec f-fm  f-w-b ml-10">
                                        <h1 className="f-s-52">We have done lot of Agency Task</h1>
                                    </div>
                                    <div className="cards flex justify-around mt-16">
                                        <div className="Card1 ">
