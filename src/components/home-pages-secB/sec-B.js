    ...
    return (
        <>
            <div className="container-fluid sec-B-main flex mt-64">
                <div className="what-we-do w-full flex mt-64">
                    <div className="secB-start w-1/2 flex justify-center mt-10 " data-aos="fade-right" data-aos-duration="2000">
                        <h1 className="f-s-52 f-fm f-w-b f-clr-black l-h-1-19">We Are Fantasy <br />We've got you <br />covered on</h1>
                    </div>
                    <div className="dead flex w-1/2" data-aos="fade-left" data-aos-duration="2000">
                        <div className="SecB-credentials flex  mt-10">
                            <div className="product-design">
                                ...
                                <div className="product-design-text absolute">
                                    <h1 className="mt-5 ml-5 f-s-25 f-fm f-clr-black f-w-600">Product Design</h1>
                        ...
                        <div className="SecB-credentials flex ml-10 mt-10">
                            <div className="product-design">
                                <div className="card-background-img float-right">
                                    <img className="back-img absolute" src={Cardbackimg} alt="card7" />
                                </div>
                                <div className="rectangle-image">
                                    <img src={Createweb} alt="rectangle" />
                                </div>
                                <div className="product-design-text absolute">
                                    <h1 className="mt-5 ml-5 f-s-25 f-fm f-clr-black f-w-600">Product Design</h1>
                                    <p className="design-text f-s-18 f-fm clr-5a">Every product must make a statement and we’re ready to create it with holistic approach to
            ...
            <div className="container-fluid home-page-second-part-main">
                ...
                <div className="who-we-are w-full flex">
                    ...
                    <div className="partB-start w-1/2 flex flex-col justify-center ml-24 mt-10" data-aos="fade-right" data-aos-duration="2000">
                        <div className="diamond-image flex justify-center ml-10">
                            <img className="diamond" src={Diamondimg} alt="diamond" />
                        </div>
                        <div className="who-we-are-heading flex justify-center  w-2/3 ml-64 "><h1 className="f-s-18 f-fm clr-5a f-w-b our-services-head">Who We Are</h1></div>
                        <div className="who-we-are-heading  flex justify-center" >
                        ...
                        <div className="read-succes-story-button mt-10 flex justify-center">
